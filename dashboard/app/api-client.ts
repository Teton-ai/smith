 ...
 */
export interface BulkDeviceReleaseIntent {
	devices: number[];
	follows_latest?: boolean;
	pinned_release_id?: number;
}
 ...
 */
export interface DebugApCredentials {
	password: string;
	serial_number: string;
	ssid: string;
}
 ...
 */
export interface DeviceReleaseIntent {
	follows_latest: boolean;
	pinned_release_id?: number;
	release_id?: number;
...
export interface SetBaseRelease {
	/**
 ...
 */
export interface UpdateDeviceReleaseIntent {
	follows_latest?: boolean;
	pinned_release_id?: number;
}
...
export const useUpdateDevicesReleaseIntentHook = () => {
	const updateDevicesReleaseIntent = useClientMutator<number>();

	return useCallback(
		(
			bulkDeviceReleaseIntent: BulkDeviceReleaseIntent,
			signal?: AbortSignal,
		) => {
			return updateDevicesReleaseIntent({
				url: `/devices/release-intent`,
				method: "PUT",
				headers: { "Content-Type": "application/json" },
				data: bulkDeviceReleaseIntent,
				signal,
			});
		},
		[updateDevicesReleaseIntent],
	);
};

export const useUpdateDevicesReleaseIntentMutationOptions = <
	TError = void,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<ReturnType<typeof useUpdateDevicesReleaseIntentHook>>>,
		TError,
		{ data: BulkDeviceReleaseIntent },
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ["updateDevicesReleaseIntent"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const updateDevicesReleaseIntent = useUpdateDevicesReleaseIntentHook();
	...
	> = (props) => {
		...
		return updateDevicesReleaseIntent(data);
	};

	return { mutationFn, ...mutationOptions };
};

export type UpdateDevicesReleaseIntentMutationResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useUpdateDevicesReleaseIntentHook>>>
>;
export type UpdateDevicesReleaseIntentMutationBody = BulkDeviceReleaseIntent;
export type UpdateDevicesReleaseIntentMutationError = void;

export const useUpdateDevicesReleaseIntent = <
	TError = void,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		useUpdateDevicesReleaseIntentMutationOptions(options),
		queryClient,
	);
};
 ...
 * @summary Derive the WPA2 password for a device's debug-access AP (`<serial>-tunnel`).
 */
export const useGetDebugApPasswordHook = () => {
	const getDebugApPassword = useClientMutator<DebugApCredentials>();

	return useCallback(
		(deviceId: string, signal?: AbortSignal) => {
			return getDebugApPassword({
				url: `/devices/${deviceId}/debug-ap-password`,
				method: "GET",
				signal,
			});
		},
...
export const getGetDebugApPasswordInfiniteQueryKey = (deviceId: string) => {
	return ["infinite", `/devices/${deviceId}/debug-ap-password`] as const;
};

export const getGetDebugApPasswordQueryKey = (deviceId: string) => {
	return [`/devices/${deviceId}/debug-ap-password`] as const;
};

export const useGetDebugApPasswordInfiniteQueryOptions = <
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>
	>,
	TError = void,
>(
	deviceId: string,
	...
	const queryKey =
		queryOptions?.queryKey ?? getGetDebugApPasswordInfiniteQueryKey(deviceId);

	const getDebugApPassword = useGetDebugApPasswordHook();

	const queryFn: QueryFunction<
		Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>
	> = ({ signal }) => getDebugApPassword(deviceId, signal);
...
export type GetDebugApPasswordInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>
>;
export type GetDebugApPasswordInfiniteQueryError = void;

export function useGetDebugApPasswordInfinite<
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>
	>,
	TError = void,
...
>(
	...
	const queryOptions = useGetDebugApPasswordInfiniteQueryOptions(
		deviceId,
		options,
	);
...
export const useGetDebugApPasswordQueryOptions = <
	TData = Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>,
	TError = void,
>(
	deviceId: string,
	options?: {
	...
	const queryKey =
		queryOptions?.queryKey ?? getGetDebugApPasswordQueryKey(deviceId);
...
export type GetDebugApPasswordQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>
>;
export type GetDebugApPasswordQueryError = void;

export function useGetDebugApPassword<
	TData = Awaited<ReturnType<ReturnType<typeof useGetDebugApPasswordHook>>>,
	TError = void,
>(
	deviceId: string,
...
>(
	...
	const queryOptions = useGetDebugApPasswordQueryOptions(deviceId, options);
...
export const useGetDeviceReleaseIntentHook = () => {
	const getDeviceReleaseIntent = useClientMutator<DeviceReleaseIntent>();

	return useCallback(
		(deviceId: number, signal?: AbortSignal) => {
			return getDeviceReleaseIntent({
				url: `/devices/${deviceId}/release-intent`,
				method: "GET",
				signal,
			});
		},
		[getDeviceReleaseIntent],
	);
};

export const getGetDeviceReleaseIntentInfiniteQueryKey = (deviceId: number) => {
	return ["infinite", `/devices/${deviceId}/release-intent`] as const;
};

export const getGetDeviceReleaseIntentQueryKey = (deviceId: number) => {
	return [`/devices/${deviceId}/release-intent`] as const;
};

export const useGetDeviceReleaseIntentInfiniteQueryOptions = <
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>
	>,
	TError = void,
>(
	deviceId: number,
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetDeviceReleaseIntentInfiniteQueryKey(deviceId);

	const getDeviceReleaseIntent = useGetDeviceReleaseIntentHook();

	const queryFn: QueryFunction<
		Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>
	> = ({ signal }) => getDeviceReleaseIntent(deviceId, signal);
...
export type GetDeviceReleaseIntentInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>
>;
export type GetDeviceReleaseIntentInfiniteQueryError = void;

export function useGetDeviceReleaseIntentInfinite<
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>
	>,
	TError = void,
...
>(
	...
	const queryOptions = useGetDeviceReleaseIntentInfiniteQueryOptions(
		deviceId,
		options,
	);
...
export const useGetDeviceReleaseIntentQueryOptions = <
	TData = Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>,
	TError = void,
>(
	deviceId: number,
	options?: {
	...
	const queryKey =
		queryOptions?.queryKey ?? getGetDeviceReleaseIntentQueryKey(deviceId);
...
export type GetDeviceReleaseIntentQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>
>;
export type GetDeviceReleaseIntentQueryError = void;

export function useGetDeviceReleaseIntent<
	TData = Awaited<ReturnType<ReturnType<typeof useGetDeviceReleaseIntentHook>>>,
	TError = void,
>(
	deviceId: number,
...
>(
	...
	const queryOptions = useGetDeviceReleaseIntentQueryOptions(deviceId, options);
...
export const useSetDeviceReleaseIntentHook = () => {
	const setDeviceReleaseIntent = useClientMutator<void>();

	return useCallback(
		(
			deviceId: number,
			updateDeviceReleaseIntent: UpdateDeviceReleaseIntent,
			signal?: AbortSignal,
		) => {
			return setDeviceReleaseIntent({
				url: `/devices/${deviceId}/release-intent`,
				method: "POST",
				headers: { "Content-Type": "application/json" },
				data: updateDeviceReleaseIntent,
				signal,
			});
		},
		[setDeviceReleaseIntent],
	);
};

export const useSetDeviceReleaseIntentMutationOptions = <
	TError = void,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<ReturnType<typeof useSetDeviceReleaseIntentHook>>>,
		TError,
		{ deviceId: number; data: UpdateDeviceReleaseIntent },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useSetDeviceReleaseIntentHook>>>,
	...
	TContext
> => {
	const mutationKey = ["setDeviceReleaseIntent"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const setDeviceReleaseIntent = useSetDeviceReleaseIntentHook();
	...
	> = (props) => {
		...
		return setDeviceReleaseIntent(deviceId, data);
	};

	return { mutationFn, ...mutationOptions };
};

export type SetDeviceReleaseIntentMutationResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useSetDeviceReleaseIntentHook>>>
>;
export type SetDeviceReleaseIntentMutationBody = UpdateDeviceReleaseIntent;
export type SetDeviceReleaseIntentMutationError = void;

export const useSetDeviceReleaseIntent = <TError = void, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<ReturnType<typeof useSetDeviceReleaseIntentHook>>>,
			TError,
...
> => {
	return useMutation(
		useSetDeviceReleaseIntentMutationOptions(options),
		queryClient,
	);
};
...
export const useGetDistributionBaseReleaseHook = () => {
	const getDistributionBaseRelease = useClientMutator<Release>();

	return useCallback(
		(distributionId: number, signal?: AbortSignal) => {
			return getDistributionBaseRelease({
				url: `/distributions/${distributionId}/base`,
				method: "GET",
				signal,
			});
		},
		[getDistributionBaseRelease],
	);
};

export const getGetDistributionBaseReleaseInfiniteQueryKey = (
	distributionId: number,
) => {
	return ["infinite", `/distributions/${distributionId}/base`] as const;
};

export const getGetDistributionBaseReleaseQueryKey = (
	distributionId: number,
) => {
	return [`/distributions/${distributionId}/base`] as const;
};

export const useGetDistributionBaseReleaseInfiniteQueryOptions = <
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>>
	>,
	TError = void,
>(
	distributionId: number,
	options?: {
		query?: Partial<
			UseInfiniteQueryOptions<
				Awaited<
					ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>
				>,
				TError,
				TData
			>
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetDistributionBaseReleaseInfiniteQueryKey(distributionId);

	const getDistributionBaseRelease = useGetDistributionBaseReleaseHook();

	const queryFn: QueryFunction<
		Awaited<ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>>
	> = ({ signal }) => getDistributionBaseRelease(distributionId, signal);
...
export type GetDistributionBaseReleaseInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>>
>;
export type GetDistributionBaseReleaseInfiniteQueryError = void;

export function useGetDistributionBaseReleaseInfinite<
	TData = InfiniteData<
		Awaited<ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>>
	>,
	TError = void,
...
>(
	...
	const queryOptions = useGetDistributionBaseReleaseInfiniteQueryOptions(
		distributionId,
		options,
	);
...
export const useGetDistributionBaseReleaseQueryOptions = <
	TData = Awaited<
		ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>
	>,
	TError = void,
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetDistributionBaseReleaseQueryKey(distributionId);
...
export type GetDistributionBaseReleaseQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>>
>;
export type GetDistributionBaseReleaseQueryError = void;

export function useGetDistributionBaseRelease<
	TData = Awaited<
		ReturnType<ReturnType<typeof useGetDistributionBaseReleaseHook>>
	>,
	TError = void,
...
>(
	...
	const queryOptions = useGetDistributionBaseReleaseQueryOptions(
		distributionId,
		options,
	);
...
export const useSetDistributionBaseReleaseHook = () => {
	const setDistributionBaseRelease = useClientMutator<Release>();
	...
	return useCallback(
		(
			...
			return setDistributionBaseRelease({
				url: `/distributions/${distributionId}/base`,
				method: "PUT",
				headers: { "Content-Type": "application/json" },
				data: setBaseRelease,
		...
		[setDistributionBaseRelease],
	);
};

export const useSetDistributionBaseReleaseMutationOptions = <
	TError = string,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<ReturnType<typeof useSetDistributionBaseReleaseHook>>>,
		TError,
		{ distributionId: number; data: SetBaseRelease },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useSetDistributionBaseReleaseHook>>>,
	...
	TContext
> => {
	const mutationKey = ["setDistributionBaseRelease"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const setDistributionBaseRelease = useSetDistributionBaseReleaseHook();
	...
	> = (props) => {
		...
		return setDistributionBaseRelease(distributionId, data);
	};

	return { mutationFn, ...mutationOptions };
};

export type SetDistributionBaseReleaseMutationResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useSetDistributionBaseReleaseHook>>>
>;
export type SetDistributionBaseReleaseMutationBody = SetBaseRelease;
export type SetDistributionBaseReleaseMutationError = string;

export const useSetDistributionBaseRelease = <
	TError = string,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		useSetDistributionBaseReleaseMutationOptions(options),
		queryClient,
	);
};
