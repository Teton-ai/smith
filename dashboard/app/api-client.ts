...
>(options?: {
	...
	TContext
> => {
	const mutationKey = ["updateDevicesFollowLatest"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	...
	TContext
> => {
	const mutationKey = ["reconcileReferences"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	mutation?: UseMutationOptions<
		...
		TError,
		{ networkId: number; data: ReferenceRequest },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useAcquireReferenceHook>>>,
	...
	TContext
> => {
	const mutationKey = ["acquireReference"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	...
	TContext
> => {
	const mutationKey = ["releaseReference"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	mutation?: UseMutationOptions<
		...
		TError,
		{ releaseId: number; data: NewOsUpload },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useCreateOsUploadHook>>>,
	...
	TContext
> => {
	const mutationKey = ["createOsUpload"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	...
	TContext
> => {
	const mutationKey = ["completeOsUpload"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
...
>(options?: {
	mutation?: UseMutationOptions<
		...
		TError,
		{ releaseId: number; partNumber: number; data: OsPartReport },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useReportOsPartHook>>>,
	...
	TContext
> => {
	const mutationKey = ["reportOsPart"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
