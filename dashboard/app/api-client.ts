...
export interface AddAuthorizedNetworkRequest {
	network_id: number;
}
...
export interface Device {
	approved: boolean;
	authorized_networks: NetworkSummary[];
	created_on: string;
	current_network?: NetworkSummary;
	has_token?: boolean;
	id: number;
...
export const useGetAuthorizedNetworksForDeviceHook = () => {
	const getAuthorizedNetworksForDevice =
		useClientMutator<AuthorizedNetwork[]>();

	return useCallback(
		(serialNumber: string, signal?: AbortSignal) => {
			return getAuthorizedNetworksForDevice({
				url: `/devices/${serialNumber}/authorized-networks`,
				method: "GET",
				signal,
			});
		},
		[getAuthorizedNetworksForDevice],
	);
};

export const getGetAuthorizedNetworksForDeviceInfiniteQueryKey = (
	serialNumber: string,
) => {
	return ["infinite", `/devices/${serialNumber}/authorized-networks`] as const;
};

export const getGetAuthorizedNetworksForDeviceQueryKey = (
	serialNumber: string,
) => {
	return [`/devices/${serialNumber}/authorized-networks`] as const;
};

export const useGetAuthorizedNetworksForDeviceInfiniteQueryOptions = <
	TData = InfiniteData<
		Awaited<
			ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>
		>
	>,
	TError = void,
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetAuthorizedNetworksForDeviceInfiniteQueryKey(serialNumber);

	const getAuthorizedNetworksForDevice =
		useGetAuthorizedNetworksForDeviceHook();

	const queryFn: QueryFunction<
		Awaited<
			ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>
		>
	> = ({ signal }) => getAuthorizedNetworksForDevice(serialNumber, signal);
...
export type GetAuthorizedNetworksForDeviceInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>>
>;
export type GetAuthorizedNetworksForDeviceInfiniteQueryError = void;

export function useGetAuthorizedNetworksForDeviceInfinite<
	TData = InfiniteData<
		Awaited<
			ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>
		>
...
>(
	...
	const queryOptions = useGetAuthorizedNetworksForDeviceInfiniteQueryOptions(
		serialNumber,
		options,
	);
...
export const useGetAuthorizedNetworksForDeviceQueryOptions = <
	TData = Awaited<
		ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>
	>,
	TError = void,
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetAuthorizedNetworksForDeviceQueryKey(serialNumber);
...
export type GetAuthorizedNetworksForDeviceQueryResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>>
>;
export type GetAuthorizedNetworksForDeviceQueryError = void;

export function useGetAuthorizedNetworksForDevice<
	TData = Awaited<
		ReturnType<ReturnType<typeof useGetAuthorizedNetworksForDeviceHook>>
	>,
	TError = void,
...
>(
	...
	const queryOptions = useGetAuthorizedNetworksForDeviceQueryOptions(
		serialNumber,
		options,
	);
...
export const useAddAuthorizedNetworkForDeviceHook = () => {
	const addAuthorizedNetworkForDevice = useClientMutator<void>();

	return useCallback(
		(
			serialNumber: string,
			addAuthorizedNetworkRequest: AddAuthorizedNetworkRequest,
			signal?: AbortSignal,
		) => {
			return addAuthorizedNetworkForDevice({
				url: `/devices/${serialNumber}/authorized-networks`,
				method: "POST",
				headers: { "Content-Type": "application/json" },
				data: addAuthorizedNetworkRequest,
				signal,
			});
		},
		[addAuthorizedNetworkForDevice],
	);
};

export const useAddAuthorizedNetworkForDeviceMutationOptions = <
	TError = void,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<
			ReturnType<ReturnType<typeof useAddAuthorizedNetworkForDeviceHook>>
		>,
		TError,
		{ serialNumber: string; data: AddAuthorizedNetworkRequest },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<ReturnType<typeof useAddAuthorizedNetworkForDeviceHook>>>,
	TError,
	{ serialNumber: string; data: AddAuthorizedNetworkRequest },
	TContext
> => {
	const mutationKey = ["addAuthorizedNetworkForDevice"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const addAuthorizedNetworkForDevice = useAddAuthorizedNetworkForDeviceHook();
	...
	> = (props) => {
		...
		return addAuthorizedNetworkForDevice(serialNumber, data);
	};

	return { mutationFn, ...mutationOptions };
};

export type AddAuthorizedNetworkForDeviceMutationResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof useAddAuthorizedNetworkForDeviceHook>>>
>;
export type AddAuthorizedNetworkForDeviceMutationBody =
	AddAuthorizedNetworkRequest;
export type AddAuthorizedNetworkForDeviceMutationError = void;

export const useAddAuthorizedNetworkForDevice = <
	TError = void,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		useAddAuthorizedNetworkForDeviceMutationOptions(options),
		queryClient,
	);
};

export const useDeleteAuthorizedNetworkForDeviceHook = () => {
	const deleteAuthorizedNetworkForDevice = useClientMutator<void>();

	return useCallback(
		(serialNumber: string, networkId: number, signal?: AbortSignal) => {
			return deleteAuthorizedNetworkForDevice({
				url: `/devices/${serialNumber}/authorized-networks/${networkId}`,
				method: "DELETE",
				signal,
			});
		},
		[deleteAuthorizedNetworkForDevice],
	);
};

export const useDeleteAuthorizedNetworkForDeviceMutationOptions = <
	TError = void,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<
			ReturnType<ReturnType<typeof useDeleteAuthorizedNetworkForDeviceHook>>
		>,
		TError,
		{ serialNumber: string; networkId: number },
		TContext
	>;
}): UseMutationOptions<
	Awaited<
	...
	TContext
> => {
	const mutationKey = ["deleteAuthorizedNetworkForDevice"];
	const { mutation: mutationOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const deleteAuthorizedNetworkForDevice =
		useDeleteAuthorizedNetworkForDeviceHook();
	...
	const mutationFn: MutationFunction<
		...
		{ serialNumber: string; networkId: number }
	> = (props) => {
		const { serialNumber, networkId } = props ?? {};

		return deleteAuthorizedNetworkForDevice(serialNumber, networkId);
	};

	return { mutationFn, ...mutationOptions };
};

export type DeleteAuthorizedNetworkForDeviceMutationResult = NonNullable<
	Awaited<
		ReturnType<ReturnType<typeof useDeleteAuthorizedNetworkForDeviceHook>>
	>
>;

export type DeleteAuthorizedNetworkForDeviceMutationError = void;

export const useDeleteAuthorizedNetworkForDevice = <
	TError = void,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		useDeleteAuthorizedNetworkForDeviceMutationOptions(options),
		queryClient,
	);
};
	...
	return useCallback(
		(serialNumber: string, signal?: AbortSignal) => {
			return getConfiguredNetworksForDevice({
				url: `/devices/${serialNumber}/configured-networks`,
				method: "GET",
				signal,
			});
		},
...
export const getGetConfiguredNetworksForDeviceInfiniteQueryKey = (
	...
	return ["infinite", `/devices/${serialNumber}/configured-networks`] as const;
};

export const getGetConfiguredNetworksForDeviceQueryKey = (
	serialNumber: string,
) => {
	return [`/devices/${serialNumber}/configured-networks`] as const;
};
...
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetConfiguredNetworksForDeviceInfiniteQueryKey(serialNumber);
	...
	const queryFn: QueryFunction<
		Awaited<
			ReturnType<ReturnType<typeof useGetConfiguredNetworksForDeviceHook>>
		>
	> = ({ signal }) => getConfiguredNetworksForDevice(serialNumber, signal);
...
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetConfiguredNetworksForDeviceQueryKey(serialNumber);
...
export const useGetWifiScanForDeviceHook = () => {
	const getWifiScanForDevice = useClientMutator<WifiScanEntry[] | void>();

	return useCallback(
		(serialNumber: string, signal?: AbortSignal) => {
			return getWifiScanForDevice({
				url: `/devices/${serialNumber}/wifi-scan`,
				method: "GET",
				signal,
			});
		},
...
export const getGetWifiScanForDeviceInfiniteQueryKey = (
	serialNumber: string,
) => {
	return ["infinite", `/devices/${serialNumber}/wifi-scan`] as const;
};

export const getGetWifiScanForDeviceQueryKey = (serialNumber: string) => {
	return [`/devices/${serialNumber}/wifi-scan`] as const;
};
...
>(
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetWifiScanForDeviceInfiniteQueryKey(serialNumber);

	const getWifiScanForDevice = useGetWifiScanForDeviceHook();

	const queryFn: QueryFunction<
		Awaited<ReturnType<ReturnType<typeof useGetWifiScanForDeviceHook>>>
	> = ({ signal }) => getWifiScanForDevice(serialNumber, signal);
...
>(
	...
	const queryKey =
		queryOptions?.queryKey ?? getGetWifiScanForDeviceQueryKey(serialNumber);
...
>(
	...
	const queryOptions = useGetWifiScanForDeviceQueryOptions(
		serialNumber,
		options,
	);
