...
async fn start_main_server(
    ...
    let (protected_router, protected_api) = OpenApiRouter::with_openapi(ApiDoc::openapi())
        ...
        .routes(routes!(
            device::route::get_authorized_networks_for_device,
            device::route::add_authorized_network_for_device
        ))
        .routes(routes!(device::route::delete_authorized_network_for_device))
